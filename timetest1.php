...
<h5>This before time is on <?php echo date('l jS \of F Y h:i:s A'); ?> </h5>
...
?>
    ...
    <!-- HTML portion of the script. --> 
        ...
        <h4>Please type in your bill total and select the tip value. Then, press the 'Calculate Tip' button to calculate what your bill will be, plus the selected tip: </h4>
        <p> 
            
         <p class="error">This before time is on <?php echo date('l jS \of F Y h:i:s A'); ?> </p>
    	...
    	<table>
        	...
        	<tr>
            	<td>
                	<input type="number" step=".01" name="given_value">
            	</td>
        	</tr>
        	<tr>
            	<td>
    ...
    switch($second_temp_type_name){ 
        ...
        case 'tip25':
                     
                        {
                            ...
                            echo "This is the bill total: $$given_value, $timenow, and tip: $$tip2</br>";        
                            echo "<b>This is the bill total, plus a 25% tip: $$total2, $timelater, </b></br>";
                    	}
        break;
        ...
        <p class="error">This calculation was done on <?php echo date('h:i:s A'); ?> </p>

        <p class="error">This calculation was done on <?php echo "$timestring"; ?> </p>
    
        <p class="error">This calculation was done on <?php echo "$timenow"; ?> </p>
