...
<?php if (!empty($error_message)) { ?>
    ...
    <p class="error">ABOVE CODE IS WRONG; PILFER FROM. USE BELOW CODE: <?php echo date('m/d/y'); ?> </p>
...
?>
    ...
    <!-- HTML portion of the script. --> 
        ...
        <h4>Please type in your bill total, and select the tip value to calculate: </h4>
        <p> 
        <h6>-----------------------------------------------------------</h6>    
    ...
    switch($second_temp_type_name){ 
        ...
        case 'tip15':
                        
                    	{
                            ...
                            echo "tip15  $given_value = $tip2 Amount </br>";
                        }
        break;
        ...
        case 'tip18':
                     
                        {
                            ...
                            $tip2 = number_format($tip, 2);
                        	echo "tip18  $given_value = $tip2 Amount </br>";
                        }
        break;
        ...
        case 'tip20':
                      
                        {
                            ...
                            $tip2 = number_format($tip, 2);
                        	echo "tip20  $given_value = $tip2 Amount </br>";
                    	}      
        break;
        ...
        case 'tip22':
                        
                    	{
                            ...
                            $tip2 = number_format($tip, 2);
                        	echo "tip22  $given_value = $tip2 Amount </br>";
                        }
        break;
        ...
        case 'tip25':
                     
                        {
                            ...
                            $tip2 = number_format($tip, 2);
                        	echo "tip25  $given_value = $tip2 Amount </br>";
                    	}
        break;
